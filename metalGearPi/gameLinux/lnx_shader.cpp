...
LnxShader::LnxShader(const char* p_vertexShaderDir, const char* p_fragmentShaderDir)
{
...
void LnxShader::setBool(const std::string& p_name, bool p_namevalue) const
{
    glUniform1i(glGetUniformLocation(ID, p_name.c_str()), (int)p_namevalue);

}

void LnxShader::setInt(const std::string& p_name, int p_value) const
{
    glUniform1i(glGetUniformLocation(ID, p_name.c_str()), p_value);
}

void LnxShader::setFloat(const std::string& p_name, float p_value) const
{
    glUniform1f(glGetUniformLocation(ID, p_name.c_str()), p_value);
}

void LnxShader::setVec3(const std::string& p_name, const glm::vec3& p_value) const
{
    glUniform3fv(glGetUniformLocation(ID, p_name.c_str()), 1, &p_value[0]);
}

void LnxShader::setVec3(const std::string& p_name, float p_x, float p_y, float p_z) const
{
    glUniform3f(glGetUniformLocation(ID, p_name.c_str()), p_x, p_y, p_z);
}

void LnxShader::setVec2(const std::string& p_name, const glm::vec2& p_value) const
{
    glUniform2fv(glGetUniformLocation(ID, p_name.c_str()), 1, &p_value[0]);
}

void LnxShader::setVec2(const std::string& p_name, float p_x, float p_y) const
{
    glUniform2f(glGetUniformLocation(ID, p_name.c_str()), p_x, p_y);
}

void LnxShader::setMat4(const std::string& p_name, const glm::mat4& p_mat) const
{
    glUniformMatrix4fv(glGetUniformLocation(ID, p_name.c_str()), 1, GL_FALSE, &p_mat[0][0]);
}

void LnxShader::setMat3(const std::string& p_name, const glm::mat3& p_mat) const
{
